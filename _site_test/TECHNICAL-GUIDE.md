...
This guide covers local development setup, architecture, customization patterns, and deployment for developers who want to modify the DIVE Data Learning Cohorts Gallery platform.
...
Key Jekyll settings:
```yaml
title: "DIVE Data Learning Cohorts Gallery"
